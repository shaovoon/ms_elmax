...
public:
	...
	DateAndTime(std::time_t time_in_sec, bool utc);
	//! Non-default constructor
	...
	void SetString(const std::wstring& strDateTime);

	//! Get the DateTime string eg, "2010-10-01 23:00:00"
	std::wstring GetString() const;

private:
	static void GetTime(time_t time_in_sec, short& year, short& mon, short& mday, short& hour, short& min, short& sec);
	static void GetUTCTime(time_t time_in_sec, short& year, short& mon, short& mday, short& hour, short& min, short& sec);
